  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" width="150" align="center">
        <template slot-scope="scope">
          <el-button type="text" size="mini" :disabled="$hasBP('btn.all') === false" @click="check(scope.row.id, 1)">审核通过</el-button>
          <el-button type="text" size="mini" :disabled="$hasBP('btn.all') === false" @click="check(scope.row.id, 0)">审核不通过</el-button>
