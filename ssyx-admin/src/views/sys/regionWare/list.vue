    ...
    >
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.status === 0" type="text" size="mini" @click="updateStatus(scope.row.id, 1)">开通
          </el-button>
          <el-button v-if="scope.row.status === 1" type="text" size="mini" @click="updateStatus(scope.row.id, 0)">
            取消开通
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="开通区域" :visible.sync="openDialogVisible" width="40%">
      <el-form ref="flashPromotionForm" label-width="150px" size="small">
        ...
        <el-form-item>
          ...
          <el-button type="primary" size="small" @click="openSave()">确 定</el-button>
