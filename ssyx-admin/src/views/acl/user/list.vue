<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button class="btn-add" size="mini" :disabled="selectedIds.length===0" style="margin: 0 10px;" @click="revomveUsers">批量删除</el-button>
    </el-card>
...
export default {
  ...
  'data': function() {
    return {
      'allRoles': [], // 是否显示列表加载的提示
      'checkAll': false,
      'dialogRoleVisible': false,
      'dialogUserVisible': false, // 所有选择的user的id的数组
      'isIndeterminate': false, // 当前页的用户列表
      'limit': 5, // 当前页码
      'listLoading': false, // 每页数量
      'loading': false, // 总数量
      'page': 1, // 当前要操作的user
